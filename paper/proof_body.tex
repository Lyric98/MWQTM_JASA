...
\subsubsection{Setup: generic observed-event weight}\label{sec:setup}
...
\subsubsection{Observed-data transport and identification}\label{sec:orth}
...
\subsubsection{Sharper population drift and projected sieve bias}\label{sec:drift}
...
\subsubsection{High-level cross-fitted one-step theorem}\label{sec:onestep}
...
\subsubsection{What is deferred, and the two routes}\label{sec:routes}
